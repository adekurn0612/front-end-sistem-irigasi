...
import {reqGetLahanTigaKalium, reqGetLahanTigaKelembapan, reqGetLahanTigaNitrogen, reqGetLahanTigaPh, reqGetLahanTigaPotasium} from '../redux/action/actionReducer';

export default function LahanTiga() {
  ...
  useEffect(() => {
    dispatch(reqGetLahanTigaKalium());
    dispatch(reqGetLahanTigaPh());
    dispatch(reqGetLahanTigaKelembapan());
    dispatch(reqGetLahanTigaPotasium());
    dispatch(reqGetLahanTigaNitrogen());
