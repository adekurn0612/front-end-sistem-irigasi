...
import {reqGetLahanSatuKalium, reqGetLahanSatuKelembapan, reqGetLahanSatuNitrogen, reqGetLahanSatuPh, reqGetLahanSatuPotasium} from '../redux/action/actionReducer';

export default function LahanSatu() {
  ...
  useEffect(() => {
    dispatch(reqGetLahanSatuKalium());
    dispatch(reqGetLahanSatuPh());
    dispatch(reqGetLahanSatuKelembapan());
    dispatch(reqGetLahanSatuPotasium());
    dispatch(reqGetLahanSatuNitrogen());
