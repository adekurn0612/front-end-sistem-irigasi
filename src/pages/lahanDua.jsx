...
import {reqGetLahanDuaKalium, reqGetLahanDuaKelembapan, reqGetLahanDuaNitrogen, reqGetLahanDuaPh, reqGetLahanDuaPotasium} from '../redux/action/actionReducer';

export default function LahanDua() {
  ...
  useEffect(() => {
    dispatch(reqGetLahanDuaKalium());
    dispatch(reqGetLahanDuaPh());
    dispatch(reqGetLahanDuaKelembapan());
    dispatch(reqGetLahanDuaPotasium());
    dispatch(reqGetLahanDuaNitrogen());
